...
#ax1.set_ylabel('STN input')
#ax1.set_title('GPe Firing rate')
#pl.colorbar()
...
#ax1.set_yticks(ext_rate[::3])
#ax1.set_ylabel('STN input')
#ax1.set_xlabel('GPe input')
#ax1.set_title('GPe Spectral Entropy')
#pl.colorbar()
...
#ax1.set_yticks([])
#ax1.set_xlabel('GPe input')
#ax1.set_title('STN Spectral Entropy')
#pl.colorbar()
