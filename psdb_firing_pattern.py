...
for i,spiking_mode in enumerate(spiking_mode_loop):
	...
	ax1 = fig.add_axes([0.1,0.7 - (i*0.275),0.33,0.225])
	#ax1 = fig.add_axes([0.6,0.66 - (i*0.22),0.37,0.2]) 
	ax1.plot(potential['times'],potential['V_m'],color = col_lis[i*2], linewidth = 2)
	ax1.plot(spikes['times'],spikes['senders']-50.,"ko",markersize = 3)
	yr = np.arange(-70.,-40.,10.)
	ax1.set_yticks(yr[::2])
	ax1.set_ylim(-80.,-40.)
