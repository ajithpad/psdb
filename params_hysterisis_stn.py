...
class Parameters(object):
    ...
    if 'olympic' in socket.getfqdn():
      ...
      nest_path_tmp = '/data/padmanabhan/tmp/nest/'
    ...
    num_chg = 600   #Number of neurons for which parameters need to be changed
